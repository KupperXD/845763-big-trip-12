...
import {CITIES, TYPES} from "../constans";
...
const renderTypes = (type) => {
  const typesClone = TYPES.slice(0, TYPES.length);
  const transfers = typesClone.splice(0, typesClone.length - 2);
  ...
  return `<div class="event__type-list">
          <fieldset class="event__type-group">
            ...
            ${renderType(transfers)}
          </fieldset>

          <fieldset class="event__type-group">
            <legend class="visually-hidden">Activity</legend>

            ${renderType(typesClone)}
          </fieldset>
        </div>`;
};
